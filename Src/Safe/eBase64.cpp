...
bool CeBase64::Encode(const unsigned char *pIn, unsigned long uInLen, string& strOut)
{
...
bool CeBase64::Encode(const unsigned char *pIn, unsigned long uInLen, unsigned char *pOut, unsigned long *uOutLen)
{
	unsigned long i, len2, leven;
	unsigned char *p;
...
bool CeBase64::Decode(const string& strIn, unsigned char *pOut, unsigned long *uOutLen)
{
